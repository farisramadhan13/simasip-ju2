...
export default function SuratMasukPage() {
  ...
  const itemsPerPage = 15; // Ditingkatkan agar lebih banyak data yang tampil berkat tabel yang lebih tinggi

  const sheetData = data?.results?.find((s: any) => s.id === "sheet-1");
  ...
  return (
    <div className="sm-container">
      {/* RAW CSS untuk memastikan desain aktif tanpa Tailwind */}
      ...
      <div className="sm-header">
        <div>
          <h1 className="sm-title">Arsip Masuk</h1>
          <p className="sm-subtitle">Pantau seluruh surat masuk secara real-time yang terhubung langsung dari Google Sheets.</p>
        </div>
